...
def main():
    ...
    parser.add_argument("--process_id", type=int, default=None, help="ID")
    parser.add_argument("--total_processes", type=int, default=10, help="Total")
    ...
    amount=int((len(textListALL)/divi)+10)
    endi=int(amount*(idProceso+1))
    starti=int(amount*idProceso)
    ...
    with open('LocalLLM/OneLLM_MultEmbVoting/answer_template_'+str(idProceso)+'.json', 'w') as file:
